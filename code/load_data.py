...
def generate_and_save_neighborhood_arrays(D1):
    ...
    np.save("../data/hmdd/nei_m_d.npy", nei_m_d_array)
    np.save("../data/hmdd/nei_d_m.npy", nei_d_m_array)


def create_mpositive_matrix():
    pos_num = 5
    p = 757
    mm = sp.load_npz("../data/hmdd//mm.npz")
    mgm = sp.load_npz("../data/hmdd//mgm.npz")
    mdm = sp.load_npz("../data/hmdd//mdm.npz")
    mgdgm = sp.load_npz("../data/hmdd/mgdgm.npz")
    ...
    sp.save_npz("../data/hmdd/m_pos.npz", pos)


def create_dpositive_matrix():
    pos_num = 5
    p = 435
    dgd = sp.load_npz("../data/hmdd//dgd.npz")
    dmd = sp.load_npz("../data/hmdd//dmd.npz")
    dgmgd = sp.load_npz("../data/hmdd/dgmgd.npz")
    ...
    pos = sp.coo_matrix(pos)
    sp.save_npz("../data/hmdd/d_pos.npz", pos)
...
def generate_npz_from_d1(D1):
    ...
    path1 = '../data/hmdd/dmd.npz'
    path2 = '../data/hmdd/mdm.npz'
    md_data = []
    dm_data = []
